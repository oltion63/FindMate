...
<template>
    <header class="flex justify-between h-16 items-center">
                ...
                <div v-if="showDropdown" class="absolute right-0 mt-2 w-64 border border-gray-500 rounded-lg z-50">
                    ...
                    <ul class="max-h-60 overflow-auto">
                        <li
                            ...
                            :key="notification.id"
                            class="px-4 py-2 bg-gray-100 cursor-pointer border-b border-gray-500"
                        >
