...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <main class="md:mx-auto mt-2 md:p-4 lg:max-w-7xl xl:p-0">
            <div>
                <div v-if="props.isPremium && page.props.auth && page.props.auth.user && page.props.auth.user.role !== 'admin'" class="mb-6 p-4 bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 font-semibold rounded">
                    🎉 You are a Premium member! Enjoy exclusive access to more jobs and features.
                </div>
